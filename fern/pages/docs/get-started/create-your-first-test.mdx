---
sidebar-title: Create your first test
---
...
A [test](/docs/get-started/tests) in Doc Detective is a series of steps, where each step performs a single [action](/docs/actions). An action can be navigating to a URL, finding an element, or taking a screenshot, for example.
