...
{/* step {"stepId":"check-example-com","description":"Verify example.com is accessible","checkLink":"https://example.com"} */}
checks for the presence of the `<h1>` heading with the text `Example Domain`, and verifies that the `Learn more` link is present. It then clicks the link and captures a screenshot of the resulting page.
