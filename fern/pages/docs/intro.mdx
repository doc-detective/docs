...
See the [Installation](/docs/get-started/installation) guide to get started. {/* step {"stepId":"check-installation-link","description":"Check /docs/get-started/installation link","checkLink":"/docs/get-started/installation"} */}

Come chat on [Discord](https://discord.gg/uAfSjVH7yr). {/* step {"stepId":"check-discord-link","description":"Check Discord invite link","checkLink":"https://discord.gg/uAfSjVH7yr"} */}
