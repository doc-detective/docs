...
To add detected test functionality to AsciiDoc files, you can define custom markup patterns in your configuration. See [custom inputs](/input-formats/custom) for examples.
...
- See [custom inputs](/input-formats/custom) to add detected test patterns for AsciiDoc
- Explore [Markdown](/input-formats/markdown) and [DITA](/input-formats/dita) formats for detected test examples
