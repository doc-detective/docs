...
:::tip[Common attributes to target]
...
- [XPath selectors](/docs/get-started/selectors/xpath): Alternative selector syntax (more complex but more powerful)
