...
:::note
For most use cases, [CSS selectors](/docs/get-started/selectors/css) are simpler and more readable. Use XPath only when CSS selectors can't accomplish what you need.
:::
...
- [CSS selectors](/docs/get-started/selectors/css): Simpler selector syntax (recommended for most cases)
